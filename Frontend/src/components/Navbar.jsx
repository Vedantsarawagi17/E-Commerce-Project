    ...
    <div className='flex items-center justify-between py-5 font-medium'>
        <Link to='/'><img src={assets.logo} className='w-36' alt="logo" /></Link> 
         ...
         <div className='flex items-center gap-6'>
            ...
            {/* Screen width < 640px: Element is visible. Screen width >= 640px: Element is hidden.*/}
        </div>
         {/*Side bar menu for small screen  */}
         <div className={`absolute top-0 right-0 border-0 overflow-hidden bg-white transition-all ${visible?'w-full':'w-0'}`}>
            <div className='flex flex-col text-gray-600 divide-y divide-gray-200'>
                 ...
                 <div className='h-px-[0.5px] bg-gray-200'></div>
            </div>
         </div>
    </div>
  )
